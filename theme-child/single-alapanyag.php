 ...
 * v7 – energia% szöveg javítás + fatsonly initial hide
 */
...
while ( have_posts() ) : the_post();
    ...
    $vitamins = [
        ...
        [ 'key' => 'vitamin_b9',  'label' => 'B9 (Folát)',           'egyseg' => 'µg' ],
    ...
    // Zsírsavak – KIZÁRÓLAG a "Zsírsavak" fülön jelennek meg
    $fats = [
    ...
    <div class="aa-content">
        ...
        <section class="aa-section">
            <div class="aa-section-header">
                <span class="aa-section-icon">📊</span>
                Tápérték összesítő
            ...
            <div class="aa-macro-grid">
                ...
                <div class="aa-macro-card aa-macro-protein">
                    ...
                    <div class="aa-macro-bar">
                        <div class="aa-macro-bar-fill" style="width: <?php echo $energia_pct_f; ?>%"></div>
                    </div>
                ...
                <div class="aa-macro-card aa-macro-carb">
                    ...
                    <div class="aa-macro-bar">
                        <div class="aa-macro-bar-fill" style="width: <?php echo $energia_pct_s; ?>%"></div>
                    </div>
                ...
                <div class="aa-macro-card aa-macro-fat">
                    ...
                    <div class="aa-macro-bar">
                        <div class="aa-macro-bar-fill" style="width: <?php echo $energia_pct_z; ?>%"></div>
                    </div>
            ...
            <div class="aa-macro-extra">
                <span>🥬 Rost: <strong><?php echo round( $rost, 1 ); ?>g</strong></span>
                <span>🍬 Cukrok: <strong><?php echo round( $cukor, 1 ); ?>g</strong></span>
                <span><span class="aa-emoji-zsir" aria-label="zsír">🧈</span> Telített zsír: <strong><?php echo round( $t_zsir, 1 ); ?>g</strong></span>
            </div>
        </section>
        ...
        <section class="aa-section">
            ...
            <div class="aa-table-wrap">
                <table class="aa-table">
                    <thead>
                        <tr>
                            <th>Általános tápanyagtartalom</th>
                    ...
                    <tbody>
                        ...
                        <tr class="aa-row-main" data-group="all macros">
                            <td><span class="aa-emoji-zsir" aria-label="zsír">🧈</span> Zsír</td>
                        ...
                        <tr class="aa-row-sub" data-group="all macros">
                            <td>↳ amelyből egyszeresen telítetlen zsírsavak (MUFA)</td>
                            <td class="aa-td-right"><?php echo round( $egyszeresen_t, 2 ); ?> g</td>
                        </tr>
                        <?php endif; ?>
                        <?php if ( $tobbszorosen_t > 0 ) : ?>
                        <tr class="aa-row-sub" data-group="all macros">
                            <td>↳ amelyből többszörösen telítetlen zsírsavak (PUFA)</td>
                        ...
                        <?php // ══════════════════════════════════════ ?>
                        <?php // ── ZSÍRSAVAK (KIZÁRÓLAG Zsírsavak fül) ?>
                        <?php // ══════════════════════════════════════ ?>

                        <?php
                        $has_fats = false;
                        foreach ( $fats as $f ) {
                            if ( aa_get_nutrient_value( $f['key'], $post_id ) > 0 ) { $has_fats = true; break; }
                        }
                        if ( $has_fats ) :
                        ?>
                            <tr class="aa-row-divider" data-group="fatsonly">
                            ...
                            <?php foreach ( $fats as $f ) :
                                ...
                                if ( $val <= 0 ) continue;
                            ?>
                                <tr data-group="fatsonly">
                                    <td><?php echo esc_html( $f['label'] ); ?></td>
                                    <td class="aa-td-right"><strong><?php echo round( $val, 2 ); ?></strong> <?php echo $f['egyseg']; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
                        ...
                        foreach ( $vitamins as $v ) {
                            if ( aa_get_nutrient_value( $v['key'], $post_id ) > 0 ) { $has_vitamins = true; break; }
                        }
                        if ( $has_vitamins ) :
                        ?>
                            <tr class="aa-row-divider" data-group="all vitamins">
                                <td colspan="2">Vitaminok</td>
                            </tr>
                            <?php foreach ( $vitamins as $v ) :
                                $val = aa_get_nutrient_value( $v['key'], $post_id );
                                if ( $val <= 0 ) continue;
                            ?>
                                <tr data-group="all vitamins">
                                    <td><?php echo esc_html( $v['label'] ); ?></td>
                                    <td class="aa-td-right"><strong><?php echo round( $val, 2 ); ?></strong> <?php echo $v['egyseg']; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
                        ...
                        foreach ( $minerals as $m ) {
                            if ( aa_get_nutrient_value( $m['key'], $post_id ) > 0 ) { $has_minerals = true; break; }
                        }
                        if ( $has_minerals ) :
                        ?>
                            <tr class="aa-row-divider" data-group="all minerals">
                                <td colspan="2">Ásványi anyagok</td>
                            </tr>
                            <?php foreach ( $minerals as $m ) :
                                $val = aa_get_nutrient_value( $m['key'], $post_id );
                                if ( $val <= 0 ) continue;
                            ?>
                                <tr data-group="all minerals">
                                    <td><?php echo esc_html( $m['label'] ); ?></td>
                                    <td class="aa-td-right"><strong><?php echo round( $val, 2 ); ?></strong> <?php echo $m['egyseg']; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
                        ...
                        <?php
                        $has_trace = false;
                        foreach ( $trace_elements as $te ) {
                            if ( aa_get_nutrient_value( $te['key'], $post_id ) > 0 ) { $has_trace = true; break; }
                        }
                        if ( $has_trace ) :
                        ?>
                            <tr class="aa-row-divider" data-group="all trace">
                                <td colspan="2">Nyomelemek</td>
                            </tr>
                            <?php foreach ( $trace_elements as $te ) :
                                $val = aa_get_nutrient_value( $te['key'], $post_id );
                                if ( $val <= 0 ) continue;
                            ?>
                                <tr data-group="all trace">
                                    <td><?php echo esc_html( $te['label'] ); ?></td>
                                    <td class="aa-td-right"><strong><?php echo round( $val, 2 ); ?></strong> <?php echo $te['egyseg']; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
        ...
        <section class="aa-section">
            <div class="aa-section-header">
                <span class="aa-section-icon">ℹ️</span>
                Forrás
            </div>
            ...
            <div class="aa-source-grid">
                ...
                <?php if ( $has_off ) : ?>
                    <div class="aa-source-card">
                        ...
                        <div class="aa-source-row">
                            <span class="aa-source-label">Vonalkód:</span>
                            <span><?php echo esc_html( $off_barcode ); ?></span>
                        </div>
                        <?php if ( $off_url ) : ?>
                            <div class="aa-source-row">
                                <a href="<?php echo esc_url( $off_url ); ?>"
                                   target="_blank"
                                   rel="noopener"
                                   class="aa-source-link">
                                    Megtekintés az OFF-en →
                                </a>
                            </div>
                        <?php endif; ?>
                        <?php if ( $off_last_sync ) : ?>
                            <div class="aa-source-row aa-source-muted">
                                Szinkron: <?php echo esc_html( $off_last_sync ); ?>
                            </div>
                        <?php endif; ?>
                ...
                <?php if ( $has_usda ) : ?>
                    <div class="aa-source-card">
                        ...
                        <div class="aa-source-row">
                            <span class="aa-source-label">FDC ID:</span>
                            <span><?php echo esc_html( $usda_fdc_id ); ?></span>
                        </div>
                        <div class="aa-source-row">
                            <a href="https://fdc.nal.usda.gov/fdc-app.html#/food-details/<?php echo intval( $usda_fdc_id ); ?>/nutrients"
                               target="_blank"
                               rel="noopener"
                               class="aa-source-link">
                                Megtekintés a USDA-n →
                            </a>
                        </div>
                        <?php if ( $usda_last_sync ) : ?>
                            <div class="aa-source-row aa-source-muted">
                                Szinkron: <?php echo esc_html( $usda_last_sync ); ?>
                            </div>
                        <?php endif; ?>
                ...
                <?php if ( $forditas_forras ) : ?>
                    <div class="aa-source-card">
                        ...
                        <div class="aa-source-row">
                            <span class="aa-source-label">Forrás:</span>
                            <span>
                                <?php
                                $forras_labels = [
                                    'deepl'           => 'DeepL API',
                                    'magyar_eredeti'  => 'Magyar eredeti',
                                    'manual'          => 'Kézi fordítás',
                                ];
                                echo esc_html( $forras_labels[ $forditas_forras ] ?? $forditas_forras );
                                ?>
                            </span>
                        </div>
                        <?php if ( $eredeti_nev && $eredeti_nev !== $title ) : ?>
                            <div class="aa-source-row">
                                <span class="aa-source-label">Eredeti:</span>
                                <span style="font-style: italic;"><?php echo esc_html( $eredeti_nev ); ?></span>
                            </div>
                        <?php endif; ?>
                        <?php if ( $forditas_datum ) : ?>
                            <div class="aa-source-row aa-source-muted">
                                Dátum: <?php echo esc_html( $forditas_datum ); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
